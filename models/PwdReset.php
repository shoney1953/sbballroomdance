...
public function readBy_selector($selector, $expirationDate) {
 
  // Create query
  $query = 'SELECT * FROM ' . $this->table . ' WHERE pwdResetSelector = :selector AND
  pwdResetExpiration >= :expirationDate
  LIMIT 0,1'; 
