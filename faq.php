...
<head>
    ...
    <title>SBDC Ballroom Dance - Frequently Asked Questions</title>
</head>
...
<div class="content-faq">
      ...
      <span class="faq-title">What ID and Password do I use to login?</span>
        ...
        <p>
          Your login id will be<em><strong> either </strong> </em> your email if you have one <em><strong> or </strong></em> your first name with the first letter 
          capitalized and the first initial of your last name capitalized. 
        </p>
          <p>
            </p> For example John Doe would have the id of JohnD.       
        </p>
        <p>
        Your initial password is test1234 in lower case.
        </p>
        <p>
