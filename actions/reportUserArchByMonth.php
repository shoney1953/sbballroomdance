...
class PDF extends FPDF
{
    function Header() {
        ...
        $title = "SaddleBrooke Ballroom Dance Club Archived Members - ".$today;
         $this->Image('../img/SBDC LOGO.png',10,6,20);
...
if ($userCount > 0) {
  ...
  $pdf->Cell(75,5,"MEMBERS BY YEAR AND MONTH ARCHIVED",0,1,"L");
  $pdf->Ln(2);
...
$today = date("m-d-Y");
$pdf->Output("I", "MemberArchByMonthReport".$today.".PDF");
}
