...
class PDF extends FPDF
{
    function Header() {
        ...
        $this->Cell(
            50,
            10,
            'SBDC Members by HOA - '.$today, 0, 1, 'C'
        );
        // Line break
        $this->Ln(20);
    }
...
if (isset($_POST['submitHOAreport'])) {
...
if ($userCount > 0) {
    ...
    $pdf->Ln(2);
    $pdf->AddPage();
    $pdf->Cell(0, 5, "Total Members HOA 1:  ".$numHOA1, 0, 1);
    $pdf->Cell(0, 5, "Total Members HOA 2:  ".$numHOA2, 0, 1);
